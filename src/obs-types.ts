...
export declare type IncomingMessage<Type = keyof IncomingMessageTypes> =
  Type extends keyof IncomingMessageTypes
    ...
    : never;
export declare type OutgoingMessage<Type = keyof OutgoingMessageTypes> =
...
declare type EventMessage<T = keyof OBSEventTypes> =
  T extends keyof OBSEventTypes
    ? {
        eventType: T;
        /**
    ...
    : never;
export declare type RequestMessage<T = keyof OBSRequestTypes> =
  T extends keyof OBSRequestTypes
    ...
    : never;
export declare type ResponseMessage<T = keyof OBSResponseTypes> =
  T extends keyof OBSResponseTypes
    ? {
        requestType: T;
        requestId: string;
        requestStatus:
